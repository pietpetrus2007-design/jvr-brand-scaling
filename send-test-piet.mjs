...
const email = 'piet200710@gmail.com';
...
const r = await resend.emails.send({
  ...
  html: `
    <div style="font-family:-apple-system,sans-serif;max-width:600px;margin:0 auto;background:#000;color:#fff;padding:40px;">
      ...
      <p style="font-size:16px;line-height:1.6;color:#ccc;">Your <strong style="color:#FF6B00;">${tier}</strong> account has been created. Click below to set your password and get access immediately:</p>
